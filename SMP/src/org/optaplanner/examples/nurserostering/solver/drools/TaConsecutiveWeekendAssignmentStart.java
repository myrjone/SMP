...
public class TaConsecutiveWeekendAssignmentStart implements Comparable<TaConsecutiveWeekendAssignmentStart>,
        Serializable {

    private Ta ta;
    private int sundayIndex;

    public TaConsecutiveWeekendAssignmentStart(Ta ta, int sundayIndex) {
        this.ta = ta;
    ...
    public boolean equals(Object o) {
        if (this == o) {
            return true;
        } else if (o instanceof TaConsecutiveWeekendAssignmentStart) {
            TaConsecutiveWeekendAssignmentStart other = (TaConsecutiveWeekendAssignmentStart) o;
