...
import org.optaplanner.examples.tarostering.solver.move.TaMultipleChangeMove;

public class CourseAssignmentPillarPartSwapMoveFactory implements MoveListFactory<TaRoster> {
